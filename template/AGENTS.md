...
| 全体構造・実現パターン・テーブル設計・設計上の制約の参照と変更 | [アーキテクチャ](docs/architecture.md)、[全体設計と先行してよい成果物](docs/standards/design-and-documentation.md#architecture-method) |
...
- **文書管理**: `docs/standards/` は編集しません。文書の更新・整理は [文書と記録の基準](docs/standards/design-and-documentation.md#document-roles) に従い、変更した事実の重複と古い説明を完了前に確認します。規約・標準・文書方針の改訂は実装作業から分離します。
