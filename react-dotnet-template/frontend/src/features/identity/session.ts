...
export const useSignIn = () => useMutation({ mutationFn: (user: string) => postJson<SignInOutput>('/api/demo/sign-in', { user } satisfies SignInInput),
...
export const useSignOut = () => useMutation({ mutationFn: () => postJson<SuccessOutput>('/api/demo/sign-out', {}),
